...
function Customize() {
  ...
  return (
    <>
      <Container>
        <div className=" rounded-xl my-5  flex-col lg:flex lg:flex-row">
          {/* First */}
          <div
            className="  md:w-2/4 w-full bg-white dark:bg-black  h-[450px] lg:h-screen"
          ...
          >
            ...
            <div className="w-full">
              <h1 className="w-full text-[29px] uppercase   text-black dark:text-black justify-center text-center">
          ...
          {/* Second */}
          <div
            className="md:w-2/4 w-full h-[650px] lg:h-screen flex flex-col"
            style={{ backgroundColor: "#f5f4f3" }}
          >
            <div className="text-[29px] uppercase  text-black dark:text-black justify-center text-left p-4">
              Body Measurements
            </div>
            <ol className="flex-grow">
              {[
                ...
                <ul>
                  <div className="text-[20px] uppercase  text-black dark:text-black justify-center text-left px-4">
                    Upper Body
                  </div>
            ...
            <div className="mt-auto  p-4  h-[250px] flex flex-col lg:justify-end items-center lg:items-end">
              {/* <div
                className="flex flex-col text-left w-full lg:text-right "
                style={{ lineHeight: "0.9" }}
              >
                <h1 className="text-[50px] font-semibold ">
                  {formData.occasion} {formData.type}
                </h1>
                <h1 className="text-[50px] font-semibold">Rs</h1>
              </div> */}

              <button
                className="m-1 text-white dark:text-black p-2 px-4 rounded-full w-[200px] h-[50px] text-xl"
              ...
              <button
                className="m-1  text-black dark:text-white p-2 px-4 rounded-full w-[200px] h-[50px] text-xl"
